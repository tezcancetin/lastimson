        ...
        <div className="flex-1 border-t border-bolt-elements-borderColor">
          <div className="flex w-full h-full justify-center items-center bg-white flex-col gap-4">
            ...
            <div className="text-gray-600 text-center">
              <div className="font-medium mb-2">Preview Loading</div>
              <div className="text-sm">
                The preview will appear here when the application starts running
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 border-t border-bolt-elements-borderColor">
        {activePreview && iframeUrl ? (
          ...
          <div className="flex w-full h-full justify-center items-center bg-white flex-col gap-4">
            <div className="text-gray-500 text-lg">⏳</div>
            <div className="text-gray-600 text-center">
              <div className="font-medium mb-2">Loading Preview</div>
              <div className="text-sm">
                Please wait, the application is starting...
              </div>
            </div>
          </div>
        )}
